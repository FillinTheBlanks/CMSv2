...
Public Class ISRptViewer
    Dim rptDoc As ReportDocument
    Dim is1 As IncomeStatementRpt
    ...
    Private Sub ISRptViewer_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Loading.Dispose()
        Loading.Close()
    End Sub
End Class